...
lesson_s01e02_bp = Blueprint("lesson_s01e02_bp", __name__)

robot_api_url = "https://xyz.ag3nts.org/verify"


@lesson_s01e02_bp.route("/start-verification", methods=["POST"])
...
@lesson_s01e02_bp.route("/submit-answer", methods=["POST"])
def submit_answer():
    try:
