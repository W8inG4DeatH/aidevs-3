...
lesson_s01e05_bp = Blueprint("lesson_s01es01e05_bp", __name__)
...
def download_proxy_file():
    try:
        ...
        external_file_url = "https://centrala.ag3nts.org/data/5e05d528-a239-488a-83f8-13e443c02c85/json.txt"
...
@lesson_s01e05_bp.route("/submit-corrected-file", methods=["POST"])
