...
@lesson_s03e02_bp.route("/get-mixed-files", methods=["GET"])
def get_mixed_files():
    try:
...
@lesson_s03e02_bp.route("/get-text-file-content", methods=["POST"])
...
@lesson_s03e02_bp.route("/save-text-file-content", methods=["POST"])
