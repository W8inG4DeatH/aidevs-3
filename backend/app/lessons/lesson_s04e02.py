...
lesson_s04e02_bp = Blueprint("lesson_s04e02_bp", __name__)


@lesson_s04e02_bp.route("/start-conversation", methods=["POST"])
...
@lesson_s04e02_bp.route("/send-command", methods=["POST"])
def send_command():
    """
...
@lesson_s04e02_bp.route("/process-image", methods=["POST"])
def process_image():
    """
